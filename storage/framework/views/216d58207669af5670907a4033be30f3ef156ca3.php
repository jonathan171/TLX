		...
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<hr>
					<div id="dropzone_">
						<form  class="dropzone_" id="frmTarget" action="<?php echo e(route("publicaciones")); ?>" method="POST" enctype="multipart/form-data">
							<?php echo e(csrf_field()); ?>

							<input type="hidden" name="nombre" value= <?php echo e(Auth::user()->name); ?>>
							...
							<div class="form-group" <?php echo e($errors->has('categoria') ? ' has-error' : ''); ?>>
								<select class="form-control input-lg" name="categoria" required="true">
									...
									<option value="<?php echo e(old('categoria')== null? '' : old('categoria')); ?>" ><?php echo e(old('categoria')== null? "Seleccione categoría" : old('categoria')); ?></option>

									<?php foreach($lista_categorias as $categorias): ?>
									<option value="<?php echo e($categorias->categoria); ?>"><?php echo e($categorias->categoria); ?></option>
									<?php endforeach; ?>
								</select>
							</div>
							<div class="s-img">
							...
							<div class="form-group<?php echo e($errors->has('archivo') ? ' has-error' : ''); ?>">
								<div class="input-group">
									
									<span class="input-group-addon">seleccione la imagen de su anuncio</span>
									<input type="file"  name="archivo[]" id="file_form" onchange="return fileValidation()" class="form-control" id="focusedinput" multiple="" value="<?php echo e(old('archivo')); ?> " required="true" size="20" multiple maxImg="8">
									<!-- Image preview -->
								...
								<span class="help-block">
									<strong><?php echo e($errors->first('archivo[]')); ?></strong>
								</span>
								<?php endif; ?>
							...
							<div class="form-group">
								<select class="form-control input-lg" name="ciudad" required="true">

									<option value="<?php echo e(old('ciudad')== null? '' : old('ciudad')); ?>" ><?php echo e(old('ciudad')== null? "Seleccione ciudad" : old('ciudad')); ?></option>
									<?php foreach($lista_ciudades as $ciudad): ?>
									<option value="<?php echo e($ciudad->ciudad); ?>"><?php echo e($ciudad->ciudad); ?></option>
									<?php endforeach; ?>
								</select>
							</div>
							<div class="form-group<?php echo e($errors->has('titulo') ? ' has-error' : ''); ?>">
								...
								<input type="text" class="form-control" id="titulo_form" name="titulo" value="<?php echo e(old('titulo')); ?>"aria-describedby="emailHelp" placeholder="ingrese titulo de su anuncio"  required="true" maxlength="60">
							...
							<div class="form-group<?php echo e($errors->has('descripcion') ? ' has-error' : ''); ?>">
								...
								<textarea class="form-control" id="descripcion_form" name="descripcion" rows="3" required="true" maxlength="200" ><?php echo e(old('descripcion')); ?></textarea>
							...
							<div class="form-group <?php echo e($errors->has('contacto') ? ' has-error' : ''); ?>">
								...
								<input type="text" class="form-control" id="contacto_form" name="contacto" value="<?php echo e(old('contacto')); ?>" aria-describedby="emailHelp" placeholder="ingrese numero de contacto" required="true" onkeypress="return valida_texto_numerico(event)" maxlength="14">
							...
							<div class="form-group <?php echo e($errors->has('precio') ? ' has-error' : ''); ?>">
								...
								<input type="text" class="form-control" id="precio_form" name="precio" value="<?php echo e(old('contacto')); ?>" aria-describedby="emailHelp" placeholder="ingrese precio del artículo" required="true" onkeypress="return valida_texto_numerico(event)" maxlength="14">
							...
							<div class="form-check">
								...
								<?php if($errors->has('confirmacion')): ?>
								<span class="help-block">
									<strong><?php echo e($errors->first('confirmacion')); ?></strong>
								</span>
								<?php endif; ?>
							</div>
							<br>
...
<script type="text/javascript">
  ...
  /* Dropzone.options.frmTarget = {
        ...
        url: '<?php echo e(route("publicaciones")); ?>',
